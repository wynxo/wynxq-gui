...
def _refresh_model_capabilities(self):
    ...
    self._job(lambda cancel, emit: self._ollama_client(endpoint).describe(model), done, failed)
...
def refreshModels(self):
    ...
    def fetch(cancel, emit):
        client = self._ollama_client(endpoint)
...
def deleteModel(self, model):
    ...
    self._job(lambda cancel, emit: self._ollama_client(endpoint).delete(model), done)
